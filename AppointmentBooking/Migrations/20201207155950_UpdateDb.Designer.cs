...
namespace AppointmentBooking.Migrations
{
    ...
    [Migration("20201207155950_UpdateDb")]
            ...
            modelBuilder.Entity("AppointmentBooking.Models.AppointmentModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppointmentId = 1,
                            AppointmentDateTime = new DateTime(2020, 12, 7, 15, 59, 47, 248, DateTimeKind.Local).AddTicks(7905),
                            PatientId = 1,
                            PractitionerId = 1
                        },
                        new
                        {
                            AppointmentId = 2,
                            AppointmentDateTime = new DateTime(2020, 12, 7, 15, 59, 47, 264, DateTimeKind.Local).AddTicks(3960),
                            PatientId = 1,
                            PractitionerId = 2
                        },
                        new
                        {
                            AppointmentId = 3,
                            AppointmentDateTime = new DateTime(2020, 12, 7, 15, 59, 47, 264, DateTimeKind.Local).AddTicks(4305),
                            PatientId = 1,
                            PractitionerId = 3
                        },
                        new
                        {
                            AppointmentId = 4,
                            AppointmentDateTime = new DateTime(2020, 12, 7, 15, 59, 47, 264, DateTimeKind.Local).AddTicks(4495),
                            PatientId = 2,
                            PractitionerId = 2
                        },
                        new
                        {
                            AppointmentId = 5,
                            AppointmentDateTime = new DateTime(2020, 12, 7, 15, 59, 47, 264, DateTimeKind.Local).AddTicks(4597),
                            PatientId = 2,
                            PractitionerId = 2
                        },
                        new
                        {
                            AppointmentId = 6,
                            AppointmentDateTime = new DateTime(2020, 12, 7, 15, 59, 47, 264, DateTimeKind.Local).AddTicks(4709),
                            PatientId = 4,
                            PractitionerId = 3
                        });
                });
